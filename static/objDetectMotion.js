...
const imageChangeThreshold = s.getAttribute("data-motionThreshold") || 0.2; //how much the image can change before we trigger motion
...
function postFile(file) {
    ...
    xhr.onload = function () {
        if (this.status === 200) {
            ...
            document.getElementById("pred").innerHTML = objects.class_name;
            //draw the boxes
            //drawBoxes(objects);
